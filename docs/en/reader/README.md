...
* Filtering: [skip rows](skip-rows.md), [skip empty cells](skip-empty-cells.md), [skip empty rows](skip-empty-row.md), [skip constants](skip-const.md), [set global type](set-type.md), [read by data type](data-type.md), [data type constants](data-type-const.md)
